...
//                    FabricBlockEntityTypeBuilder.create(AlloyMixerBlockEntity::new, ModBlocks.ALLOY_MIXER).build(null));
    ...
    public static BlockEntityType<FluorescentLightBlockEntity> FLUORESCENT_LIGHT =
            Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(Lawnchair.MODID, "fluorescent_light_be"),
                    FabricBlockEntityTypeBuilder.create(FluorescentLightBlockEntity::new, ModBlocks.FLUORESCENT_LIGHT).build());
